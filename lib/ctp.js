...
(function() {
	...
	this.createMdApi = function() {
		...
		let mdFlowpath = path.join(flowpath, frontend.BrokerID + '_' + this.investor.InvestorID + '_' + 'md');
	...
	this.createTdApi = function() {
		let { flowpath, frontend } = this.setting;
		let tdFlowpath = path.join(flowpath, frontend.BrokerID + '_' + this.investor.InvestorID + '_' + 'td');
