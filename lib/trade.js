...
class Trade {
  constructor(ctp, { privateTopicMode, publicTopicModel } = { privateTopicMode: 2, publicTopicModel: 2 }) {
    this.ctp = ctp;
    this._init({ privateTopicMode, publicTopicModel });
  }

  _init({ privateTopicMode, publicTopicModel }) {
    let ctp = this.ctp;
    ...
    td.SubscribePrivateTopic(privateTopicMode);
    td.SubscribePublicTopic(publicTopicModel);
    ctp.registerTdFront();
  }
