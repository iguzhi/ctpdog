...
class Trade {
  constructor(ctp, { privateTopicMode, publicTopicMode }) {
    this.ctp = ctp;
    helper.isUndefined(privateTopicMode) && (privateTopicMode = 2);
    helper.isUndefined(publicTopicMode) && (publicTopicMode = 2);
  ...
  subscribeTopic({ privateTopicMode, publicTopicMode }) {
    let td = this.ctp.td;
    helper.isNumber(privateTopicMode) && td.SubscribePrivateTopic(privateTopicMode);
    helper.isNumber(publicTopicMode) && td.SubscribePublicTopic(publicTopicMode);
  }
