...
var filepath_ThostFtdcUserApiDataType = path.join(__dirname, '../linux_api_trade_6.3.6/ThostFtdcUserApiDataType.h');
...
fs.readFile(filepath_ThostFtdcUserApiDataType, 'utf8', (err, data) => {
  ...
  fs.writeFile(path.join(__dirname, './dict.js'), text, function(err) {
    if (err) throw err;
